class CalcController{
    ...
    toggleAudio(){
        //this._audioOnOff = (this._audioOnOff) ? false : true; é o mesmo que o código abaixo
    ...
    //pega o último item do array, como padrão o parametro informa que está procurando um operador e não um número
    //caso nenhum parametro seja informado por padrão ele procurará um operador
    getLastItem(isOperator = true){
        let lastItem;
        
        for(let i = this._operation.length - 1; i >= 0; i--){//percorre o array 
    ...
    addDot(){
        ...
        //verifica se já tem um ponto na operação
